...
- [ ] M5-T03-S03 `MediaGallery.tsx` nel dettaglio pratica: griglia thumbnail, lightbox, eliminazione con conferma; test `tests/components/media-gallery.test.tsx`. *(nota 2026-09-11: al tablet le foto della pratica in corso si vedono nella scheda di ispezione; la galleria nel pannello di dettaglio della dashboard resta da fare)*
