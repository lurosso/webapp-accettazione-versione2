...
// <input type="file" accept="image/*" capture="environment"> sulla fotocamera del tablet.
//
// GET restituisce l'elenco delle foto già acquisite, con l'indirizzo per rileggerle.
