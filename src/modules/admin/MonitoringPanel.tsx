  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div>
          <h2 className="text-lg font-semibold text-slate-900">Sportelli e monitoraggio</h2>
          <p className="text-sm text-slate-600">
            Chi è collegato a ogni sportello e cosa sta lavorando. Da qui si guarda la coda di un
            banco, si scollega chi ha finito il turno e si sbloccano le pratiche rimaste ferme.
          </p>
        </div>
        <Link
          href="/accettazione?view=global&sola-lettura=1&monitor=Coda%20globale"
          data-testid="monitora-globale"
          className="bg-brand-secondary hover:bg-brand-blue-dark focus-visible:ring-brand-blue-light inline-flex min-h-11 items-center rounded-md px-4 text-sm font-semibold text-white focus-visible:ring-2 focus-visible:outline-none"
        >
