...
// Pannello di amministrazione: andamento della giornata, operatori, assistenza e integrazione
// WhatsApp (Spoki). Quattro sezioni, una sotto l'altra: un amministratore ci entra per un motivo
// preciso (vedere come sta andando, creare un utente, sbloccare una pratica, capire perché un
// messaggio non è partito) e deve trovarlo senza cercare schede.
//
    ...
    <div className="flex flex-col gap-6">
      <header>
        ...
        <p className="text-sm text-slate-600">
          Andamento della giornata, operatori, assistenza e integrazione Spoki. Lo stato dei sistemi
          esterni e la coda verso il CRM sono nella pagina Sistema.
        </p>
      </header>
